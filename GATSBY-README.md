...
<<<<<<< HEAD
main Gatsby configuration files you might need to get up and running blazing fast with the blazing fast app generator for React.
=======
...
>>>>>>> 2aaf96d6ca99f9a91f6a8158b034cc3ed3a12aae
...
5. **`gatsby-browser.js`**: This file is where Gatsby expects to find any usage
  ...
  **`gatsby-ssr.js`**: This file is where Gatsby expects to find any usage of the
